...
namespace Azure.AI.Language.Documents
{
    ...
    public partial class DocumentError
    {
        ...
        internal DocumentError(string id, AnalyzeDocumentsError error)
        {
        ...
        internal DocumentError(string id, AnalyzeDocumentsError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Error = error;
