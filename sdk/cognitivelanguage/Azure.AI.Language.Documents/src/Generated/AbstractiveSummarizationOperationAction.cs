...
namespace Azure.AI.Language.Documents
{
    ...
    public partial class AbstractiveSummarizationOperationAction : AnalyzeDocumentsOperationAction
    {
        ...
        internal AbstractiveSummarizationOperationAction(string name, AnalyzeDocumentsOperationActionKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, AbstractiveSummarizationActionContent actionContent) : base(name, kind, serializedAdditionalRawData)
        {
