...
{
    internal partial class UnknownDocumentLocation : IUtf8JsonSerializable, IJsonModel<DocumentLocation>
    {
        ...
        internal static UnknownDocumentLocation DeserializeUnknownDocumentLocation(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            DocumentLocationKind kind = "Unknown";
            ...
            return new UnknownDocumentLocation(kind, serializedAdditionalRawData);
        }
        ...
        internal static new UnknownDocumentLocation FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeUnknownDocumentLocation(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<DocumentLocation>(this, ModelSerializationExtensions.WireOptions);
            return content;
        }
    }
}
