...
namespace Azure.AI.Language.Documents
{
    ...
    public abstract partial class AnalyzeDocumentsOperationAction
    {
        ...
        internal AnalyzeDocumentsOperationAction(string name, AnalyzeDocumentsOperationActionKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Kind = kind;
