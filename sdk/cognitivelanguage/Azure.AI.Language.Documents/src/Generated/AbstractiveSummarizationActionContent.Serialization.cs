...
{
    public partial class AbstractiveSummarizationActionContent : IUtf8JsonSerializable, IJsonModel<AbstractiveSummarizationActionContent>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AbstractiveSummarizationActionContent>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AbstractiveSummarizationActionContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AbstractiveSummarizationActionContent IJsonModel<AbstractiveSummarizationActionContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AbstractiveSummarizationActionContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static AbstractiveSummarizationActionContent DeserializeAbstractiveSummarizationActionContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AbstractiveSummarizationActionContent>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AbstractiveSummarizationActionContent>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AbstractiveSummarizationActionContent IPersistableModel<AbstractiveSummarizationActionContent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AbstractiveSummarizationActionContent>)this).GetFormatFromOptions(options) : options.Format;
