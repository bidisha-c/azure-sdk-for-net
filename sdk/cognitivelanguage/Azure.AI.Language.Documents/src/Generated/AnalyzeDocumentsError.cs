...
namespace Azure.AI.Language.Documents
{
    ...
    public partial class AnalyzeDocumentsError
    {
        ...
        internal AnalyzeDocumentsError(AnalyzeDocumentsErrorCode code, string message, string target, IReadOnlyList<AnalyzeDocumentsError> details, InnerErrorModel innererror, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Target = target;
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeDocumentsError"/> for deserialization. </summary>
        ...
        public IReadOnlyList<AnalyzeDocumentsError> Details { get; }
