...
{
    [PersistableModelProxy(typeof(UnknownDocumentLocation))]
    public partial class DocumentLocation : IUtf8JsonSerializable, IJsonModel<DocumentLocation>
    {
        ...
        internal static DocumentLocation DeserializeDocumentLocation(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            if (element.TryGetProperty("kind", out JsonElement discriminator))
            {
                ...
                {
                    case "AzureBlob": return AzureBlobDocumentLocation.DeserializeAzureBlobDocumentLocation(element, options);
                }
            }
            return UnknownDocumentLocation.DeserializeUnknownDocumentLocation(element, options);
        }
