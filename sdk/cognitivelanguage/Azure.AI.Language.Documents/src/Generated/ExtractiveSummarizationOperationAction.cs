...
namespace Azure.AI.Language.Documents
{
    ...
    public partial class ExtractiveSummarizationOperationAction : AnalyzeDocumentsOperationAction
    {
        ...
        {
            Kind = AnalyzeDocumentsOperationActionKind.ExtractiveSummarization;
        }
        ...
        internal ExtractiveSummarizationOperationAction(string name, AnalyzeDocumentsOperationActionKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, ExtractiveSummarizationActionContent actionContent) : base(name, kind, serializedAdditionalRawData)
        {
