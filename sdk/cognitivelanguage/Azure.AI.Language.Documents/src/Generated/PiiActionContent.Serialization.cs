...
namespace Azure.AI.Language.Documents
{
    public partial class PiiActionContent : IUtf8JsonSerializable, IJsonModel<PiiActionContent>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExcludeExtractionData))
            {
                writer.WritePropertyName("excludeExtractionData"u8);
                writer.WriteBooleanValue(ExcludeExtractionData.Value);
            }
        ...
        internal static PiiActionContent DeserializePiiActionContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            bool? excludeExtractionData = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("excludeExtractionData"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    excludeExtractionData = property.Value.GetBoolean();
                    continue;
                }
                if (options.Format != "W")
                {
