...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class SentimentAnalysisLROTask : AnalyzeTextLROTask
    {
        ...
        internal SentimentAnalysisLROTask(string taskName, AnalyzeTextLROTaskKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, SentimentAnalysisTaskContent parameters) : base(taskName, kind, serializedAdditionalRawData)
        {
