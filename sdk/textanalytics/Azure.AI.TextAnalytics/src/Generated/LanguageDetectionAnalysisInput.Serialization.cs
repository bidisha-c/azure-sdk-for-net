...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LanguageDetectionAnalysisInput>)this).Write(writer, ModelSerializationExtensions.WireOptions);
