...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class KeyPhraseResult
    {
        ...
        internal KeyPhraseResult(IEnumerable<DocumentError> errors, string modelVersion, IEnumerable<KeyPhrasesDocumentResultWithDetectedLanguage> documents)
        {
        ...
        internal KeyPhraseResult(IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, IReadOnlyList<KeyPhrasesDocumentResultWithDetectedLanguage> documents, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Errors = errors;
