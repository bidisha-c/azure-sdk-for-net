...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public static partial class AILanguageAnalyzeTextModelFactory
    {
        ...
        public static AnalyzeTextError AnalyzeTextError(ErrorCode code = default, string message = null, string target = null, IEnumerable<AnalyzeTextError> details = null, InnerErrorModel innererror = null)
        {
        ...
        /// The available derived classes include <see cref="AnalyzeText.AbstractiveSummarizationLROTask"/>, <see cref="AnalyzeText.CustomAbstractiveSummarizationLROTask"/>, <see cref="CustomEntitiesLROTask"/>, <see cref="CustomHealthcareLROTask"/>, <see cref="CustomMultiLabelClassificationLROTask"/>, <see cref="CustomSentimentAnalysisLROTask"/>, <see cref="CustomSingleLabelClassificationLROTask"/>, <see cref="EntityLinkingLROTask"/>, <see cref="EntitiesLROTask"/>, <see cref="ExtractiveSummarizationLROTask"/>, <see cref="HealthcareLROTask"/>, <see cref="KeyPhraseLROTask"/>, <see cref="PiiLROTask"/> and <see cref="SentimentAnalysisLROTask"/>.
        /// </param>
        ...
        /// <param name="dateValues"> List of date values. </param>
        ...
        public static SentimentDocumentResultWithDetectedLanguage SentimentDocumentResultWithDetectedLanguage(string id = null, IEnumerable<DocumentWarning> warnings = null, DocumentStatistics statistics = null, DocumentSentimentValue sentiment = default, SentimentConfidenceScores confidenceScores = null, IEnumerable<SentenceSentiment> sentences = null, DetectedLanguage detectedLanguage = null)
        {
            warnings ??= new List<DocumentWarning>();
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeText.FhirBundle"/>. </summary>
        /// <param name="additionalProperties"> Additional Properties. </param>
        /// <returns> A new <see cref="AnalyzeText.FhirBundle"/> instance for mocking. </returns>
        ...
        public static CustomSentimentAnalysisResultDocument CustomSentimentAnalysisResultDocument(string id = null, IEnumerable<DocumentWarning> warnings = null, DocumentStatistics statistics = null, DocumentSentimentValue sentiment = default, SentimentConfidenceScores confidenceScores = null, IEnumerable<CustomSentenceSentiment> sentences = null, DetectedLanguage detectedLanguage = null)
        {
            warnings ??= new List<DocumentWarning>();
        ...
        {
            return new CustomEntitiesTaskContent(loggingOptOut, projectName, deploymentName, stringIndexType, serializedAdditionalRawData: null);
        }
        ...
        {
            return new CustomSingleLabelClassificationTaskContent(loggingOptOut, projectName, deploymentName, serializedAdditionalRawData: null);
        }
        ...
        {
            return new CustomMultiLabelClassificationTaskContent(loggingOptOut, projectName, deploymentName, serializedAdditionalRawData: null);
        }
        ...
        {
            return new CustomSentimentAnalysisTaskContent(loggingOptOut, projectName, deploymentName, stringIndexType, serializedAdditionalRawData: null);
        }
        ...
        {
            return new AbstractiveSummarizationLROTask(taskName, AnalyzeTextLROTaskKind.AbstractiveSummarization, serializedAdditionalRawData: null, parameters);
        }
        ...
        public static CustomAbstractiveSummarizationLROTask CustomAbstractiveSummarizationLROTask(string taskName = null, CustomAbstractiveSummarizationTaskContent parameters = null)
        {
            return new CustomAbstractiveSummarizationLROTask(taskName, AnalyzeTextLROTaskKind.CustomAbstractiveSummarization, serializedAdditionalRawData: null, parameters);
        }

        /// <summary> Initializes a new instance of <see cref="AnalyzeText.CustomAbstractiveSummarizationTaskContent"/>. </summary>
        ...
        /// <param name="projectName"> This field indicates the project name for the model. </param>
        /// <param name="deploymentName"> This field indicates the deployment name for the model. </param>
        /// <returns> A new <see cref="AnalyzeText.CustomAbstractiveSummarizationTaskContent"/> instance for mocking. </returns>
        public static CustomAbstractiveSummarizationTaskContent CustomAbstractiveSummarizationTaskContent(int? sentenceCount = null, StringIndexType? stringIndexType = null, SummaryLengthBucket? summaryLength = null, bool? loggingOptOut = null, string projectName = null, string deploymentName = null)
        {
            return new CustomAbstractiveSummarizationTaskContent(
                sentenceCount,
                stringIndexType,
                summaryLength,
                loggingOptOut,
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeText.CustomHealthcareTaskAttributes"/>. </summary>
        /// <param name="loggingOptOut"> logging opt out. </param>
        /// <param name="projectName"> This field indicates the project name for the model. </param>
        /// <param name="deploymentName"> This field indicates the deployment name for the model. </param>
        /// <param name="stringIndexType"> Optional parameter to provide the string index type used to interpret string offsets. Defaults to TextElements (Graphemes). </param>
        /// <returns> A new <see cref="AnalyzeText.CustomHealthcareTaskAttributes"/> instance for mocking. </returns>
        public static CustomHealthcareTaskAttributes CustomHealthcareTaskParameters(bool? loggingOptOut = null, string projectName = null, string deploymentName = null, StringIndexType? stringIndexType = null)
        {
            return new CustomHealthcareTaskAttributes(loggingOptOut, projectName, deploymentName, stringIndexType, serializedAdditionalRawData: null);
        }
    }
}
