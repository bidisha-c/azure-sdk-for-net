        ...
        internal static KeyPhraseResult DeserializeKeyPhraseResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("documents"u8))
                {
                    ...
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(KeyPhrasesDocumentResultWithDetectedLanguage.DeserializeKeyPhrasesDocumentResultWithDetectedLanguage(item, options));
                    }
                    documents = array;
                    continue;
                }
            ...
            return new KeyPhraseResult(errors, statistics, modelVersion, documents, serializedAdditionalRawData);
        }
