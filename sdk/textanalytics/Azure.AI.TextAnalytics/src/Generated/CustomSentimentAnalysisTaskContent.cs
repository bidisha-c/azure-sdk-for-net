...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class CustomSentimentAnalysisTaskContent
    {
        ...
        internal CustomSentimentAnalysisTaskContent(bool? loggingOptOut, string projectName, string deploymentName, StringIndexType? stringIndexType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="CustomSentimentAnalysisTaskContent"/> for deserialization. </summary>
        internal CustomSentimentAnalysisTaskContent()
        {
        }
