...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnalyzeTextLROTask>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static UnknownAnalyzeTextLROTask DeserializeUnknownAnalyzeTextLROTask(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownAnalyzeTextLROTask(taskName, kind, serializedAdditionalRawData);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<AnalyzeTextLROTask>(this, ModelSerializationExtensions.WireOptions);
            return content;
        }
    }
}
