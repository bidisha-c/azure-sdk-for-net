...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class EntitiesDocumentResultWithMetadataDetectedLanguage
    {
        ...
        internal EntitiesDocumentResultWithMetadataDetectedLanguage(string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, IReadOnlyList<EntityWithMetadata> entities, DetectedLanguage detectedLanguage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Warnings = warnings;
