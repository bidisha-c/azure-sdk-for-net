...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class SentimentDocumentResultWithDetectedLanguage
    {
        ...
        internal SentimentDocumentResultWithDetectedLanguage(string id, IEnumerable<DocumentWarning> warnings, DocumentSentimentValue sentiment, SentimentConfidenceScores confidenceScores, IEnumerable<SentenceSentiment> sentences)
        {
        ...
        internal SentimentDocumentResultWithDetectedLanguage(string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, DocumentSentimentValue sentiment, SentimentConfidenceScores confidenceScores, IReadOnlyList<SentenceSentiment> sentences, DetectedLanguage detectedLanguage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Warnings = warnings;
