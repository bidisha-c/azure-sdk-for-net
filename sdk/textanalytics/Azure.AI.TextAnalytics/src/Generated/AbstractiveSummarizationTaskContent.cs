...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class AbstractiveSummarizationTaskContent
    {
        ...
        internal AbstractiveSummarizationTaskContent(bool? loggingOptOut, string modelVersion, int? sentenceCount, StringIndexType? stringIndexType, SummaryLengthBucket? summaryLength, string query, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
