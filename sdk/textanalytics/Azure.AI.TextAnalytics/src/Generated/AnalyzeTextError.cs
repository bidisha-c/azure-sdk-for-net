...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class AnalyzeTextError
    {
        ...
        internal AnalyzeTextError(ErrorCode code, string message, string target, IReadOnlyList<AnalyzeTextError> details, InnerErrorModel innererror, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Target = target;
