...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class CustomSentimentAnalysisResultDocument
    {
        ...
        internal CustomSentimentAnalysisResultDocument(string id, IEnumerable<DocumentWarning> warnings, DocumentSentimentValue sentiment, SentimentConfidenceScores confidenceScores, IEnumerable<CustomSentenceSentiment> sentences)
        {
        ...
        internal CustomSentimentAnalysisResultDocument(string id, IReadOnlyList<DocumentWarning> warnings, DocumentStatistics statistics, DocumentSentimentValue sentiment, SentimentConfidenceScores confidenceScores, IReadOnlyList<CustomSentenceSentiment> sentences, DetectedLanguage detectedLanguage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Warnings = warnings;
