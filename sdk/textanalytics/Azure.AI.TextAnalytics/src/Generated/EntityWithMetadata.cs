...
namespace Azure.AI.Language.AnalyzeText
{
    ...
    public partial class EntityWithMetadata
    {
        ...
        internal EntityWithMetadata(string text, string category, string subcategory, int offset, int length, double confidenceScore, string type, IReadOnlyList<EntityTag> tags, BaseMetadata metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
            Category = category;
