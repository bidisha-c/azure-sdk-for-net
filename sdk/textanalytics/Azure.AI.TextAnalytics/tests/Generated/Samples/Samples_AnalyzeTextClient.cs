...
namespace Azure.AI.Language.AnalyzeText.Samples
{
    public partial class Samples_AnalyzeTextClient
    {
        ...
        public void Example_AnalyzeText_AnalyzeText_ShortVersion_Convenience()
        {
            ...
            AnalyzeTextTask analyzeTextTask = new AnalyzeTextDynamicClassificationInput();
            Response<AnalyzeTextTaskResult> response = client.AnalyzeText(analyzeTextTask);
        }
        ...
        public async Task Example_AnalyzeText_AnalyzeText_ShortVersion_Convenience_Async()
        {
            ...
            AnalyzeTextTask analyzeTextTask = new AnalyzeTextDynamicClassificationInput();
            Response<AnalyzeTextTaskResult> response = await client.AnalyzeTextAsync(analyzeTextTask);
        }
...
Language = "<language>",
            ...
            Response<AnalyzeTextTaskResult> response = client.AnalyzeText(analyzeTextTask, showStats: true);
        }
...
Language = "<language>",
            ...
            Response<AnalyzeTextTaskResult> response = await client.AnalyzeTextAsync(analyzeTextTask, showStats: true);
        }
